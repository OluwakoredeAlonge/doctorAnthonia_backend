...
<main class="pt-20 min-h-screen">
  ...
  @if($course->selar_url)
  <!-- Selar purchase banner -->
  <div class="bg-gradient-to-r from-gold/10 to-amber-50 border-b border-gold/20 px-6 py-5">
    <div class="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="font-semibold text-primary text-sm">This is a paid course</p>
          <p class="text-gray-500 text-xs">Purchase access on Selar to watch all episodes.</p>
        </div>
      </div>
      <a href="{{ $course->selar_url }}" target="_blank" rel="noopener"
         class="inline-flex items-center gap-2 bg-gold hover:bg-gold-light text-white font-bold text-sm px-7 py-3 rounded-full shadow-lg shadow-gold/25 transition-all flex-shrink-0">
